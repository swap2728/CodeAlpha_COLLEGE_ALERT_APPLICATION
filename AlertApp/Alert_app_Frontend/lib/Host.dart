...
class SignInAsHost extends StatefulWidget {
  @override
  _SignInAsHostState createState() => _SignInAsHostState();
}

class _SignInAsHostState extends State<SignInAsHost> {
  ...
  void loginUser() async{
    if(emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
      ...
      var response = await http.post(Uri.parse("http://192.168.42.31:5000/api/Host"),
      ...
      if(jsonResponse['status']){
        ...
        // pre=
        Navigator.push(context, MaterialPageRoute(builder: (context)=>Dashbord(token: myToken, pre: jsonResponse['pre'],)));
      }else{
